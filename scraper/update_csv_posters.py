...
# --- CONFIG ---
CSV_PATH = "scraper/vortex_data.csv"
OUTPUT_PATH = "scraper/vortex_data_updated.csv"
API_KEY = os.getenv("TMDB_API_KEY", "c7c066ef756e5e7d2349ec6acb2924f3")
